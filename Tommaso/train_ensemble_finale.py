...
def train_ensemble():
    ...
    if os.path.exists(config.BEST_PARAMS_XGB_PATH):
        ...
        # MODIFICA: Cambiato 'tree_method' in 'gpu_hist' per XGBoost
        xgb_params = dict(objective='binary:logistic', eval_metric='logloss',
                          ...
                          tree_method='gpu_hist',  # <--- MODIFICA GPU
    ...
    for tr_idx, va_idx in splitter.split(X, y.values):
        ...
        if 'lgbm' in config.MODEL_TYPES:
            ...
            # ATTENZIONE: Se i tuoi 'best_params.json' ESISTONO,
            # devi aggiungere "device": "gpu" a quel file manualmente!
        ...
        if 'cat' in config.MODEL_TYPES and CatBoostClassifier is not None:
            ...
            for sd in seeds:
                ...
                # ATTENZIONE: Se i tuoi 'best_params_cat.json' ESISTONO,
                # devi aggiungere "task_type": "GPU" a quel file manualmente!
        ...
        if 'xgb' in config.MODEL_TYPES and xgb is not None:
            ...
            for sd in seeds:
                ...
                # ATTENZIONE: Se i tuoi 'best_params_xgb.json' ESISTONO,
                # devi cambiare "tree_method": "gpu_hist" a quel file manualmente!
